    ...
    <main className="flex min-h-screen flex-col">
      ...
      <div className="my-[28px] w-full">
        ...
        <div className="flex mt-[16px]">
          <div className="block w-[130px] h-[250px] md:w-[250px] md:h-[450px] ">
            <Image
          ...
          <div className="flex  flex-col ml-[16px] w-[calc(100%-150px)]">
            <h1 className="text-[10px] md:text-2xl font-bold text-white">
              {dataAnime.title}
            </h1>
            <h2 className="text-[8px] md:text-sm font-bold text-white">
              {dataAnime.title_japanese}
            </h2>
            <div className="flex gap-[8px] mt-[8px]">
              <p className="text-[8px] md:text-sm font-bold text-white ">
            ...
            <p className="  text-[4px] md:text-[12px] font-bold text-white mt-[4px] ">
              {dataAnime.synopsis}
            </p>
          </div>
        </div>
